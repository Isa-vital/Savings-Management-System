...
try {
    ...
    $memberStmt = $pdo->query("SELECT member_no, full_name FROM memberz ORDER BY full_name");
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="member_id" class="form-select">
                                    ...
                                    <?php foreach ($members as $member): ?>
                                        <option value="<?= htmlspecialchars($member['member_no']) ?>" 
                                            <?= $filters['member_id'] == $member['member_no'] ? 'selected' : '' ?>>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="align-self-center">
                                        <span class="badge badge-deposit rounded-pill p-2">
                        ...
                        <div class="card transaction-card transaction-withdrawal">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="align-self-center">
                                        <span class="badge badge-withdrawal rounded-pill p-2">
                        ...
                        <div class="card transaction-card transaction-loan">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="align-self-center">
                                        <span class="badge badge-loan rounded-pill p-2">
